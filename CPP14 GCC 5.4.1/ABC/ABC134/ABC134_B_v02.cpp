...
// [status]   https://atcoder.jp/contests/abc134/submissions/6484361 : AC

#include <iostream>
#include <string>

unsigned short calculate_num_monitor (const unsigned short* num_tree_all, const unsigned short* num_range)
{
	...
	if ( (*num_tree_all % num_tree_monitored) != 0 ) { num_monitor += (unsigned short)(1); }
