...
! [status]   https://atcoder.jp/contests/abc133/submissions/6313494 : AC
...
module ABC133
  ...
  subroutine task_C
    ...
    loop_sml: do itr_sml = range_min,         range_max - 1_INT64, 1_INT64
    loop_lrg: do itr_lrg = itr_sml + 1_INT64, range_max,           1_INT64
      buffer = mod(itr_sml * itr_lrg, 2019_INT64)
      if (buffer .lt. answer ) answer = buffer
      if (answer .eq. 0_INT64) exit loop_sml
    end do loop_lrg
    end do loop_sml
