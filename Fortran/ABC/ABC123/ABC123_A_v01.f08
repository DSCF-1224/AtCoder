...
! [status]   https://atcoder.jp/contests/abc123/submissions/4866623 : AC
...
module ABC123
  ...
  subroutine ABC123_A
    ...
    integer(kind=INT8) :: itr_Lv1, itr_Lv2

    ! STEP.01
    ! read out the coordinate of the antennas
    do itr_Lv1 = 1, num_antenna, 1
      read(unit=INPUT_UNIT, fmt='(I3)') coordinate(itr_Lv1)
    end do
    ...
    do itr_Lv1 = 1_INT8,         num_antenna-1_INT8, 1_INT8
    do itr_Lv2 = itr_Lv1+1_INT8, num_antenna,        1_INT8
      if ( coordinate(itr_Lv2) - coordinate(itr_Lv1) .gt. distance_max ) then
