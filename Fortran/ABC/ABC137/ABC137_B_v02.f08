...
! [status]   https://atcoder.jp/contests/abc137/submissions/6839745 : AC
...
module ABC137
  ...
  subroutine task_B (val_width, val_coordinate)
    ...
    ! STEP.02
    ! adjust the range
    val_coordinate_min = max(val_coordinate_min, val_coordinate_min_limit)
    val_coordinate_max = min(val_coordinate_max, val_coordinate_max_limit)
