...
! [status]   https://atcoder.jp/contests/abc137/submissions/6806117 : AC
...
module ABC137
  ...
  subroutine task_A (A, B)
    ...
    integer(INT16) :: val_max

    ! STEP.01
    ! calculate the answer of this task
    val_max = A + B
    val_max = max(val_max, A - B)
    val_max = max(val_max, A * B)

    ! STEP.02
    ! output the answer of this task
    write(unit=OUTPUT_UNIT, fmt='(I0)', advance='yes') val_max
