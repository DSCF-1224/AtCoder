...
! [status]   https://atcoder.jp/contests/jsc2019-qual/submissions/7110675 : AC
...
module JSC2019
  ...
  subroutine task_A
    ...
    do itr_month = 1_INT32, num_months_per_year, 1_INT32
    do itr_day   = 1_INT32, num_days_per_month,  1_INT32

      if (itr_day .ge. 20_INT32) then

        digit01 = mod(itr_day, 10_INT32)
        digit10 = (itr_day - digit01) / 10_INT32

        if (digit01 .ge. 2_INT32 .and. digit01 * digit10 .eq. itr_month) then
